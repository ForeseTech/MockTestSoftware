...
<body>
	...
	<div id="graph-overview">
		...
		<div id="graph-desc">
			<p class="graph-desc-paras" id="para1">Core Subjects</p>
			<p class="graph-desc-paras">Quantitative</p>
			<p class="graph-desc-paras">Data Structures</p>
			<p class="graph-desc-paras">General Programming</p>
			<p class="graph-desc-paras">Verbal</p>
		</div>
	</div>
